              ...
              <div className="flex flex-col gap-5.5 p-6.5">
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-stroke bg-transparent py-[13px] pl-6 pr-10 font-medium outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                  >
