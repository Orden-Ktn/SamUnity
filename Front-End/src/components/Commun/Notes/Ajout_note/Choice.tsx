              ...
              <div className="flex flex-col gap-5.5 p-6.5">
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-stroke bg-transparent py-[13px] pl-6 pr-50 font-medium outline-none focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                  >
          ...
          <div className="flex flex-col gap-5.5 rounded-[10px] border border-stroke bg-white p-6.5 shadow-1">
            {loading ? (
              ...
              <div>
                ...
                <table className="w-full border-collapse border border-[#ddd] sm:grid-cols-8 md:px-6 2xl:px-7.5 table-auto">
                  <thead>
