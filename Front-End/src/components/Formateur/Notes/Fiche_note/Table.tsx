                ...
                <tbody>
                  {results.map((result, index) => (
                    <tr key={result.id}>
                      ...
                      <td className="border px-4 py-2 text-dark text-center">
                        Interros : <em className="font-bold"> {result.moyenne_interro ? result.moyenne_interro.toFixed(2) : "-"} </em> <br />
                        Générale: <em className="font-bold"> {result.moyenne_generale ? result.moyenne_generale.toFixed(2) : "-"} </em>
                        </td>
                    </tr>
                  ))}
                </tbody>
