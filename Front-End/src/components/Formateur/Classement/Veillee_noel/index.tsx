...
export default function Ajout_bilan() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/api/app/ajout_classement_veillee_noel/",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <>
      <Breadcrumb pageName="Ajout Classement du Réveillon de Noël" />
              ...
              <div className="flex flex-col gap-5.5 p-6.5">
                ...
                <p className="block justify-center text-body-sm font-medium text-dark dark:text-white">
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <div className="w-1/8">
                      <select
                        name="veillee_noel_heure1"
                        value={formData.veillee_noel_heure1}
                        onChange={handleChange}
                ...
                <div className="flex gap-6">
                  <div className="w-1/2">
                    <select
                      name="ap1_veillee_noel"
                      value={formData.ap1_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                  ...
                  <div className="w-1/2">
                    <select
                      name="as1_veillee_noel"
                      value={formData.as1_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                  ...
                  <div className="w-1/2">
                    <select
                      name="pc1_veillee_noel"
                      value={formData.pc1_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                ...
                <div className="flex gap-6">
                  <div className="w-1/2">
                    ...
                    <select
                      name="ce1_veillee_noel1"
                      value={formData.ce1_veillee_noel1}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                  ...
                  <div className="w-1/2">
                    ...
                    <select
                      name="ce2_veillee_noel1"
                      value={formData.ce2_veillee_noel1}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                ...
                <div className="flex gap-6">
                  <div className="w-1/2">
                    ...
                    <input
                      type="text"
                      placeholder=""
                      name="th1_veillee_noel"
                      value={formData.th1_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    />
                  </div>
                  <div className="w-1/2">
                    ...
                    <input
                      type="text"
                      placeholder=""
                      name="na1_veillee_noel"
                      value={formData.na1_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    />
                  </div>
                ...
                <p className="block justify-center text-body-sm font-medium text-dark dark:text-white">
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <div className="w-1/8">
                      <select
                        name="veillee_noel_heure2"
                        value={formData.veillee_noel_heure2}
                        onChange={handleChange}
                        className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-2 py-1 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                      >
                ...
                <div className="flex gap-6">
                  <div className="w-1/2">
                    <select
                      name="ap2_veillee_noel"
                      value={formData.ap2_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                      <option value="">Choisissez l'AP</option>
                  ...
                  <div className="w-1/2">
                    <select
                      name="as2_veillee_noel"
                      value={formData.as2_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                      <option value="">Choisissez l'AS</option>
                  ...
                  <div className="w-1/2">
                    <select
                      name="pc2_veillee_noel"
                      value={formData.pc2_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                      <option value="">Choisissez le PC</option>
                ...
                <div className="flex gap-6">
                  <div className="w-1/2">
                    ...
                    <select
                      name="ce1_veillee_noel2"
                      value={formData.ce1_veillee_noel2}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                      <option value="">Choisissez le CE1</option>
                  ...
                  <div className="w-1/2">
                    ...
                    <select
                      name="ce2_veillee_noel2"
                      value={formData.ce2_veillee_noel2}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    >
                      <option value="">Choisissez le CE2</option>
                ...
                <div className="flex gap-6">
                  <div className="w-1/2">
                    ...
                    <input
                      type="text"
                      placeholder=""
                      name="th2_veillee_noel"
                      value={formData.th2_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    />
                  </div>
                  <div className="w-1/2">
                    ...
                    <input
                      type="text"
                      placeholder=""
                      name="na2_veillee_noel"
                      value={formData.na2_veillee_noel}
                      onChange={handleChange}
                      className="w-full rounded-[7px] border-[1.5px] border-stroke bg-transparent px-5.5 py-3 text-dark outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:focus:border-primary"
                    />
                  </div>
