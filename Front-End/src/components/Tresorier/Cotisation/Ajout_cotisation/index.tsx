...
export default function Ajout_cotisation_enfant() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("http://localhost:8000/api/app/ajout_cotisation_enfant/", {
        method: "POST",
        headers: {
  ...
  return (
    <>
      <Breadcrumb pageName="Ajout Cotisation Enfant" />
            ...
            <div className="flex w-full rounded-[10px] border-l-6 border-green bg-green-light-7 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
              ...
              <div className="w-full">
                <h5 className="mb-1 font-bold leading-[40px] text-[#004434] dark:text-[#34D399]">
                  Cotisation du jour enregistrée avec succès !
                </h5>
