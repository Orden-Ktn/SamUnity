...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "Ajout activité",
        route: "/Organisateur/activites/ajout_activite",
      },

      {
        ...
        children: [
          {
            label: "Ajout du bilan",
            route: "/Organisateur/bilan_activite/bilan_response",
          },
          {
            label: "Récapitulatif",
            route: "/Organisateur/bilan_activite/recap_bilan",
          },
        ],
      },

      {
        ...
        children: [
        {
          ...
          route: "/Organisateur/note/ajout_note",
        },
        {
          label: "Fiche de note",
          route: "/Organisateur/note/fiche_note",
        },
      ],
      },
...

      {
        ...
        route: "/Organisateur/depot_epreuve",
      },
    ],
  },
];
