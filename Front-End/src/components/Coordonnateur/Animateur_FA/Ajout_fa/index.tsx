...
export default function Ajout_responsable() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("http://localhost:8000/api/app/ajout_responsable/", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        setErrors(data.nom || "Erreur lors de l'inscription du responsable.");
      }
      
    } catch (error) {
      setErrors("Erreur de connexion au serveur. Veuillez réessayer plus tard.");
  ...
  return (
    <>
      <Breadcrumb pageName="Ajout Responsable" />
        ...
        <div className="flex flex-col gap-9">
            ...
            <div className="flex w-full rounded-[10px] border-l-6 border-green bg-green-light-7 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
              ...
              <div className="w-full">
                <h5 className="mb-1 font-bold leading-[40px] text-[#004434] dark:text-[#34D399]">
                  Responsable inscrit avec succès !
                </h5>
          ...
          {errors && (
            <div className="flex w-full rounded-[10px] border-l-6 border-red-light bg-red-light-5 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
              ...
              <div className="w-full">
                <h5 className="mb-2 font-bold leading-[22px] text-[#BC1C21]">Erreur lors de l'inscription du responsable.</h5>
                <ul>
              ...
              <div className="flex flex-col gap-5.5 p-6.5">
                ...
                <label className="mb-3 block text-body-sm font-medium text-dark dark:text-white">
                  ...
                  >
                    ...
                    {["CO", "FG", "SG", "IG", "TG", "OG", "CC 1", "CC 2", "FA"].map(statut => (
