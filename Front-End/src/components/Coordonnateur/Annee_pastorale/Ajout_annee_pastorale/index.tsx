...
export default function Ajout_annee() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("http://localhost:8000/api/app/ajout_annee_pastorale/", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        setErrors(data.annee || "Erreur lors de l'ajout de l'année.");
      }
    } catch (error) {
  ...
  return (
    <>
      <Breadcrumb pageName="Ajout Année pastorale" />
        ...
        <div className="flex flex-col gap-9">
            ...
            <div className="flex w-full rounded-[10px] border-l-6 border-green bg-green-light-7 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
              ...
              <div className="w-full">
                <h5 className="mb-1 font-bold leading-[40px] text-[#004434] dark:text-[#34D399]">
                  Année pastorale créée avec succès !
                </h5>
          ...
          {errors && (
            <div className="flex w-full rounded-[10px] border-l-6 border-red-light bg-red-light-5 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
              ...
              <div className="w-full">
                <h5 className="mb-2 font-bold leading-[22px] text-[#BC1C21]">Erreur lors de l'ajout de l'année.</h5>
                <ul>
